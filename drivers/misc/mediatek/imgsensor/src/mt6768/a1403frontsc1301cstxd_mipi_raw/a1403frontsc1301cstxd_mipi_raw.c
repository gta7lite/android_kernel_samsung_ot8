 ...
 *============================================================================
 ****************************************************************************/
/*hs14 code for SR-AL6528A-01-20 by hudongdong at 2022-11-22 start*/
...
#include "a1403frontsc1301cstxd_mipi_raw.h"
//#include "sc1301cs_pdaf_cal.h"
#define PFX "SC1301CS_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A1403FRONTSC1301CSTXD_SENSOR_ID,
	...
	.pre = {
		...
		.mipi_pixel_rate = 480000000, /* unit , ns */	/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,
	},
	.cap = {
		.pclk = 120000000,
...
{
	{ 4208, 3120, 40, 12, 4128, 3096, 4128, 3096, 0, 0, 4128, 3096, 0, 0, 4128, 3096 }, // Preview
	{ 4208, 3120, 40, 12, 4128, 3096, 4128, 3096, 0, 0, 4128, 3096, 0, 0, 4128, 3096 }, // capture
	{ 4208, 3120, 40, 12, 4128, 3096, 4128, 3096, 0, 0, 4128, 3096, 0, 0, 4128, 3096 }, // video
	{ 4208, 3120, 248, 282, 3712, 2556, 3712, 2556, 0, 0, 3712, 2556, 0, 0, 3712, 2556 }, //hight speed video
	{ 4208, 3120, 400, 282, 3408, 2556, 3408, 2556, 0, 0, 3408, 2556, 0, 0, 3408, 2556 }, // slim video
	{ 4208, 3120, 408, 288, 3392, 2544, 1696, 1272, 0, 0, 1696, 1272, 0, 0, 1696, 1272 }, // custom1
	{ 4208, 3120, 248, 516, 3712, 2088, 1856, 1044, 0, 0, 1856, 1044, 0, 0, 1856, 1044 }, // custom2
	{ 4208, 3120, 40, 400, 4128, 2320, 2064, 1160, 0, 0, 2064, 1160, 0, 0, 2064, 1160 }, // custom3
	{ 4208, 3120, 40, 12, 4128, 3096, 2064, 1548, 0, 0, 2064, 1548, 0, 0, 2064, 1548 }, // custom4
	{ 4208, 3120, 40, 398, 4128, 2324, 4128, 2324, 0, 0, 4128, 2324, 0, 0, 4128, 2324 },// custom5
}; /*cpy from preview*/
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < SC1301CS_SENSOR_GAIN_BASE)
		reg_gain = SC1301CS_SENSOR_GAIN_BASE;
	else if (reg_gain > SC1301CS_SENSOR_GAIN_MAX)
		reg_gain = SC1301CS_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 SC1301CS_AGC_Param[SC1301CS_SENSOR_GAIN_MAP_SIZE][2] = {
		{  1024,  0x00 },
		{  2048,  0x01 },
		{  4096,  0x03 },
		{  8192,  0x07 },
	...
	for (gain_index = SC1301CS_SENSOR_GAIN_MAP_SIZE - 1; gain_index > 0; gain_index--)
		if (reg_gain >= SC1301CS_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0x3e09, SC1301CS_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * SC1301CS_SENSOR_GAIN_BASE / SC1301CS_AGC_Param[gain_index][0];
...
write_cmos_sensor(0x391c,0x32);
write_cmos_sensor(0x391d,0x19);
write_cmos_sensor(0x3931,0x01);
write_cmos_sensor(0x3932,0x87);
write_cmos_sensor(0x3933,0xc0);
write_cmos_sensor(0x3934,0x07);
write_cmos_sensor(0x3940,0x74);
write_cmos_sensor(0x3942,0x00);
write_cmos_sensor(0x3943,0x08);
...
write_cmos_sensor(0x36e9,0x04);
write_cmos_sensor(0x36f9,0x04);
write_cmos_sensor(0x301f,0x9e);
write_cmos_sensor(0x302d,0x20);
write_cmos_sensor(0x3106,0x01);
write_cmos_sensor(0x3200,0x00);
write_cmos_sensor(0x3201,0x28);
write_cmos_sensor(0x3202,0x00);
write_cmos_sensor(0x3203,0x0c);
write_cmos_sensor(0x3204,0x10);
write_cmos_sensor(0x3205,0x57);
write_cmos_sensor(0x3206,0x0c);
write_cmos_sensor(0x3207,0x33);
...
write_cmos_sensor(0x36e9,0x04);
write_cmos_sensor(0x36f9,0x04);
write_cmos_sensor(0x301f,0x9f);
write_cmos_sensor(0x302d,0x20);
write_cmos_sensor(0x3106,0x01);
write_cmos_sensor(0x3200,0x00);
write_cmos_sensor(0x3201,0xf8);
write_cmos_sensor(0x3202,0x01);
write_cmos_sensor(0x3203,0x1a);
write_cmos_sensor(0x3204,0x0f);
write_cmos_sensor(0x3205,0x87);
write_cmos_sensor(0x3206,0x0b);
write_cmos_sensor(0x3207,0x25);
write_cmos_sensor(0x3208,0x0e);
write_cmos_sensor(0x3209,0x80);
write_cmos_sensor(0x320a,0x09);
write_cmos_sensor(0x320b,0xfc);
write_cmos_sensor(0x3210,0x00);
write_cmos_sensor(0x3211,0x08);
write_cmos_sensor(0x3212,0x00);
write_cmos_sensor(0x3213,0x08);
...
{
/*SC1300CS_MIPI_24Minput_4lane_1140Mbps_10bit
3408x2556
30fps_non_continue*/
write_cmos_sensor(0x0103,0x01);
mDELAY(10);
...
write_cmos_sensor(0x36e9,0x04);
write_cmos_sensor(0x36f9,0x04);
write_cmos_sensor(0x301f,0xa0);
write_cmos_sensor(0x302d,0x20);
write_cmos_sensor(0x3106,0x01);
write_cmos_sensor(0x3200,0x01);
write_cmos_sensor(0x3201,0x90);
write_cmos_sensor(0x3202,0x01);
write_cmos_sensor(0x3203,0x1a);
write_cmos_sensor(0x3204,0x0e);
write_cmos_sensor(0x3205,0xef);
write_cmos_sensor(0x3206,0x0b);
write_cmos_sensor(0x3207,0x25);
write_cmos_sensor(0x3208,0x0d);
write_cmos_sensor(0x3209,0x50);
write_cmos_sensor(0x320a,0x09);
write_cmos_sensor(0x320b,0xfc);
write_cmos_sensor(0x3210,0x00);
write_cmos_sensor(0x3211,0x08);
...
write_cmos_sensor(0x36e9,0x04);
write_cmos_sensor(0x36f9,0x04);
write_cmos_sensor(0x301f,0xa1);
write_cmos_sensor(0x302d,0x20);
write_cmos_sensor(0x3106,0x01);
write_cmos_sensor(0x3200,0x01);
write_cmos_sensor(0x3201,0x98);
write_cmos_sensor(0x3202,0x01);
write_cmos_sensor(0x3203,0x20);
write_cmos_sensor(0x3204,0x0e);
write_cmos_sensor(0x3205,0xe7);
write_cmos_sensor(0x3206,0x0b);
write_cmos_sensor(0x3207,0x1f);
write_cmos_sensor(0x3208,0x06);
write_cmos_sensor(0x3209,0xa0);
write_cmos_sensor(0x320a,0x04);
write_cmos_sensor(0x320b,0xf8);
write_cmos_sensor(0x3210,0x00);
...
write_cmos_sensor(0x36e9,0x04);
write_cmos_sensor(0x36f9,0x04);
write_cmos_sensor(0x301f,0xa2);
write_cmos_sensor(0x302d,0x20);
write_cmos_sensor(0x3106,0x01);
write_cmos_sensor(0x3200,0x00);
write_cmos_sensor(0x3201,0xf8);
write_cmos_sensor(0x3202,0x02);
write_cmos_sensor(0x3203,0x04);
write_cmos_sensor(0x3204,0x0f);
write_cmos_sensor(0x3205,0x87);
write_cmos_sensor(0x3206,0x0a);
write_cmos_sensor(0x3207,0x3b);
write_cmos_sensor(0x3208,0x07);
write_cmos_sensor(0x3209,0x40);
write_cmos_sensor(0x320a,0x04);
write_cmos_sensor(0x320b,0x14);
write_cmos_sensor(0x3210,0x00);
write_cmos_sensor(0x3211,0x04);
write_cmos_sensor(0x3212,0x00);
write_cmos_sensor(0x3213,0x04);
...
write_cmos_sensor(0x36e9,0x04);
write_cmos_sensor(0x36f9,0x04);
write_cmos_sensor(0x301f,0xa3);
write_cmos_sensor(0x302d,0x20);
write_cmos_sensor(0x3106,0x01);
write_cmos_sensor(0x3200,0x00);
write_cmos_sensor(0x3201,0x28);
write_cmos_sensor(0x3202,0x01);
write_cmos_sensor(0x3203,0x90);
write_cmos_sensor(0x3204,0x10);
write_cmos_sensor(0x3205,0x57);
write_cmos_sensor(0x3206,0x0a);
write_cmos_sensor(0x3207,0xaf);
write_cmos_sensor(0x3208,0x08);
write_cmos_sensor(0x3209,0x10);
write_cmos_sensor(0x320a,0x04);
write_cmos_sensor(0x320b,0x88);
write_cmos_sensor(0x3210,0x00);
write_cmos_sensor(0x3211,0x04);
write_cmos_sensor(0x3212,0x00);
write_cmos_sensor(0x3213,0x04);
...
write_cmos_sensor(0x36e9,0x04);
write_cmos_sensor(0x36f9,0x04);
write_cmos_sensor(0x301f,0xa5);
write_cmos_sensor(0x302d,0x20);
write_cmos_sensor(0x3106,0x01);
write_cmos_sensor(0x3200,0x00);
write_cmos_sensor(0x3201,0x28);
write_cmos_sensor(0x3202,0x01);
write_cmos_sensor(0x3203,0x8e);
write_cmos_sensor(0x3204,0x10);
write_cmos_sensor(0x3205,0x57);
write_cmos_sensor(0x3206,0x0a);
write_cmos_sensor(0x3207,0xb1);
write_cmos_sensor(0x3208,0x10);
write_cmos_sensor(0x3209,0x20);
write_cmos_sensor(0x320a,0x09);
write_cmos_sensor(0x320b,0x14);
...
//+songshiyang.wt, ADD, 2022/02/25, add main camera o22_sc1301cs eeprom bring up

#define OTP_PORTING 0
...
static struct stCAM_CAL_DATAINFO_STRUCT o22_sc1301cs_eeprom_data ={
	.sensorID= A1403FRONTSC1301CSTXD_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x0D5F,
...
static struct stCAM_CAL_CHECKSUM_STRUCT o22_sc1301cs_Checksum[8] =
{
...
#if OTP_PORTING
				size = imgSensorReadEepromData(&o22_sc1301cs_eeprom_data,o22_sc1301cs_Checksum);
				if(size != o22_sc1301cs_eeprom_data.dataLength) {
					if(o22_sc1301cs_eeprom_data.dataBuffer != NULL) {
						kfree(o22_sc1301cs_eeprom_data.dataBuffer);
						o22_sc1301cs_eeprom_data.dataBuffer = NULL;
					}
					printk("sc1301cs get eeprom data failed %d\n",size);
					//*sensor_id = 0xFFFFFFFF;
					//return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("sc1301cs get eeprom data success\n");
					imgSensorSetEepromData(&o22_sc1301cs_eeprom_data);
				}
#endif
//-, ADD, 2022/02/25, add main camera o22_sc1301cs eeprom bring up
				pr_err("sc1301cs i2c write id : 0x%x, sensor id: 0x%x\n",
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_err("sc1301cs Read id fail,sensor id: 0x%x\n", *sensor_id);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	return ERROR_NONE;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			sensor_id =(read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108); //return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		sc1301cs_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
		break;
#endif
