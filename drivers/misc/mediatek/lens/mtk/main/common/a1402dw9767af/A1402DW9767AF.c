...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	char puSendCmd1[2] = {0x04 ,  (char)(a_u2Data & 0xFF)};
	LOG_INF("@xiaofei_a_u2Data :0x%x \n", a_u2Data);
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	LOG_INF("@xiaofei_move [curr] %d [target] %d\n", g_u4CurrPosition, g_u4TargetPosition); 
...
/* ////////////////////////////////////////////////////////////// */
long A1402DW9767AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int A1402DW9767AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int A1402DW9767AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int A1402DW9767AF_GetFileName(unsigned char *pFileName)
{
